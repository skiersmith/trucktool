<template>
    <div>
        ...
        <button@click="toggleKeepForm" class="btn btn-info">Keep Form</button>
        <button@click="toggleVaultForm" class="btn btn-info">Vault Form</button>
            ...
            <div class="brown">
                ...
                <div v-for="vault in vaults">
                    <router-link :to="{name: 'Vault', params: {vaultId: vault.VaultId, vault: vault }}">
                        <p>{{vault.name}}</p>
                    </router-link>
                </div>
    </div>
